...
func SetupLoginRoutes(router *gin.RouterGroup) {
	...
	router.POST("/seller/verifyOTP", loginHandler.VerifyOTP)
	router.POST("/seller/getOTP", loginHandler.GetOTP)
	router.POST("/seller/verifyPin", loginHandler.VerifyPin)
	router.POST("/customer/verifyOTP", loginHandler.VerifyOTPForCustomer)
	router.POST("/customer/getOTP", loginHandler.GetOTPForCustomer)
	router.POST("/customer/verifyPin", loginHandler.VerifyPinForCustomer)
