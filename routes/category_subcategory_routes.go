...
func SetupCategorySubcategoryRoutes(router *gin.RouterGroup) {
	...
	router.GET("/getAllSubCategories/:id", categorySubcategoryHandler.GetAllSubcategories)
	...
	router.DELETE("/deleteCategory/:id", categorySubcategoryHandler.DeleteCategory)

	// // Subcategory routes
	router.GET("/getSubCategories", categorySubcategoryHandler.GetSubcategories)
	...
	router.GET("/getCategoriesAndSubCategory", categorySubcategoryHandler.GetCategorySubCategoryForSpecificStore)
	router.GET("/getSubCategoryForStore", categorySubcategoryHandler.GetSubCategoryForStoreCategory)
